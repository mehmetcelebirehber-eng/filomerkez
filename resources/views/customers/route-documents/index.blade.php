                    ...
                    <div>
                        ...
                        <select name="document_id" required class="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                            ...
                            @foreach($sourceDocuments as $cDoc)
                                @php
                                    // Eğer documentable (Vehicle veya Driver) silinmişse veya yoksa
                                ...
                                @endphp
                                <option value="{{ $cDoc->id }}">
                                    [{{ $prefix }}] - {{ $cDoc->document_name }} {{ $cDoc->end_date ? '(Bitiş: '.$cDoc->end_date->format('d.m.Y').')' : '' }}
                                </option>
                            @endforeach
                        </select>
                    </div>
