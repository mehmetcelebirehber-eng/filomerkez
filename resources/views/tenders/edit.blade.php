        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-slate-500 mt-1">{{ $tender->institution_name }} bilgilerini güncelleyin</p>
                </div>
            </div>
            ...
            <form action="{{ route('tenders.update', $tender->id) }}" method="POST">
                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="group relative">
                            ...
                            <input type="text" name="institution_name" value="{{ old('institution_name', $tender->institution_name) }}" required
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="group relative">
                            <textarea name="vehicle_details" rows="3"
                                class="block w-full rounded-2xl border-slate-200 bg-slate-50/50 p-4 text-sm font-medium text-slate-700 shadow-sm transition-all duration-300 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 hover:border-slate-300">{{ old('vehicle_details', $tender->vehicle_details) }}</textarea>
                        </div>
                ...
                <div class="mt-10 flex items-center justify-end border-t border-slate-100 pt-6">
                    <button type="submit" class="group relative inline-flex items-center justify-center gap-3 overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-500/30 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-500/40 active:scale-95">
                        ...
                        <i class="fi fi-rr-disk text-lg"></i>
                    </button>
                </div>
            </form>
        </div>
